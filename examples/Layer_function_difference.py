...
top, w3, h3 = pb.placeImage(c, img1path, x, y, 522, "Image 3", 0)
top, w4, h4 = pb.placeImage(c, img2path, x, y, 522, "Image 4", 1)
c.top.difference()
...
top, w4, h4 = pb.placeImage(c, img2path, x, y, 522, "Image 5", 1)
top, w3, h3 = pb.placeImage(c, img1path, x, y, 522, "Image 6", 0)
c.top.difference()
